...
We have assumed these template images will enable \gls*{rpp} and \gls*{ssp} to produce solar system discoveries and alerts, however, further investigation into the quality of observations required for suitable incremental templates is needed. 
		...
		\begin{figure}
			...
			\begin{tabular}{c c c}
				...
				\frame{\includegraphics[width=0.3\textwidth]{results/histograms_templates_tscale/hist_first_year_one_snap_v4_0_10yrs_db_noDD_noTwi_doALLTemplateMetrics_reduceNTemplate_r_noDD_noTwi.pdf}} &
				\frame{\includegraphics[width=0.3\textwidth]{results/histograms_templates_tscale/hist_first_year_one_snap_v4_0_10yrs_db_noDD_noTwi_doALLTemplateMetrics_reduceSeeingTemplate_r_noDD_noTwi.pdf}} &
				\frame{\includegraphics[width=0.3\textwidth]{results/histograms_templates_tscale/hist_first_year_one_snap_v4_0_10yrs_db_noDD_noTwi_doALLTemplateMetrics_reduceDepthTemplate_r_noDD_noTwi.pdf}} \\
...
%				\small
  ...
  % 		\begin{figure}
		% 	\centering
		% 	\begin{tabular}{c c}
		% 		\includegraphics[width=0.4\textwidth]{results/skymaps/skymaps_delta_tscale_first_year_one_snap_v4_0_10yrs_db_noDD_noTwi_doAllTemplateMetrics_reduceCount_28d-7d_u_28_noDD_noTwi.pdf} &
		% 		\includegraphics[width=0.4\textwidth]{results/skymaps/skymaps_delta_tscale_first_year_one_snap_v4_0_10yrs_db_noDD_noTwi_doAllTemplateMetrics_reduceCount_28d-7d_g_28_noDD_noTwi.pdf} \\
		% 		\includegraphics[width=0.4\textwidth]{results/skymaps/skymaps_delta_tscale_first_year_one_snap_v4_0_10yrs_db_noDD_noTwi_doAllTemplateMetrics_reduceCount_28d-7d_r_28_noDD_noTwi.pdf} &
		% 		\includegraphics[width=0.4\textwidth]{results/skymaps/skymaps_delta_tscale_first_year_one_snap_v4_0_10yrs_db_noDD_noTwi_doAllTemplateMetrics_reduceCount_28d-7d_i_28_noDD_noTwi.pdf} \\
		% 		\includegraphics[width=0.4\textwidth]{results/skymaps/skymaps_delta_tscale_first_year_one_snap_v4_0_10yrs_db_noDD_noTwi_doAllTemplateMetrics_reduceCount_28d-7d_z_28_noDD_noTwi.pdf} &
		% 		\includegraphics[width=0.4\textwidth]{results/skymaps/skymaps_delta_tscale_first_year_one_snap_v4_0_10yrs_db_noDD_noTwi_doAllTemplateMetrics_reduceCount_28d-7d_y_28_noDD_noTwi.pdf} \\
		% 	\end{tabular}
		% 	\caption{
		% 	}
		% 	\label{fig:template_skymaps_delta-7_28days}
