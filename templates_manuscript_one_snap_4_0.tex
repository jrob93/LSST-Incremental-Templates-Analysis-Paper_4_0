...
Future investigations should account for any changes to the survey schedule as the timeline becomes more clear.
		...
		This is particularly relevant for \gls*{sso} science that requires rapid followup, such as \glspl*{pha}, \glspl*{iso} and temporary Earth satellites \citep{fedoretsEstablishingEarthMinimoon2020}.
