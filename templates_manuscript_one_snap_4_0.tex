...
\end{tabular}
			\caption{
				...
				The \sout{\textbf{left}} \red{\textbf{upper}} panel shows the number of images used in a template, where a minimum of 4 was required in these simulations. % NB left panel uses a curve of the histogram to highlight differences
...
The \textbf{top} panels show the number of visits for the \baseline and \sout{\textbf{middle}} \red{\textbf{bottom}} panels are the number of visits with templates for $\Delta t = 7\ \si{d}$.
...
Only a small number of visits in the \gls*{nes} meet the template requirements, which results in a strong decrease in the discovery metric for this region.
}
...
L.McG. provided a comparison of results at the healpixel and vist size scales.
