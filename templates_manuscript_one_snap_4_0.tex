...
Altogether these results show that the loss of visits due to template generation depends strongly on the filter and area of sky being considered.
		...
		\begin{figure}
			...
			\frame{\includegraphics{results/histograms/hist_first_year_one_snap_v4_0_10yrs_db_noDD_noTwi_CountMetric_doAllTemplateMetrics_reduceCount_all_noDD_noTwi.pdf}}
...
%			\end{tabular}
				...
				\frame{\includegraphics{results/first_year_one_snap_v4_0_10yrs_db_noDD_noTwi_cum_baseline_g.pdf}} \\
				\frame{\includegraphics{results/first_year_one_snap_v4_0_10yrs_db_noDD_noTwi_cum_baseline_r.pdf}} &
				\frame{\includegraphics{results/first_year_one_snap_v4_0_10yrs_db_noDD_noTwi_cum_baseline_i.pdf}} \\
				\frame{\includegraphics{results/first_year_one_snap_v4_0_10yrs_db_noDD_noTwi_cum_baseline_z.pdf}} &
				\frame{\includegraphics{results/first_year_one_snap_v4_0_10yrs_db_noDD_noTwi_cum_baseline_y.pdf}} \\
			\end{tabular}
